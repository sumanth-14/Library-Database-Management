...
$q1="SELECT I.issue_id, B.title, R.username, I.issue_date, I.return_date 
  ...
  <tbody>
    ...
    if($result->num_rows>0){
      while($row=$result->fetch_assoc()){
        echo "<tr>";
        echo "<form action='staffreturn.php?id=$row[issue_id]' method='POST'>";
        echo "<td>$row[issue_id]</td>";
        echo "<td>$row[title]</td>";
        echo "<td>$row[username]</td>";
        echo "<td>$row[issue_date]</td>";
        echo "<td>$row[return_date]</td>";
        echo "<td><button class='btn btn-outline-primary'>Returned</button></td></form>";
        echo "</tr>";
