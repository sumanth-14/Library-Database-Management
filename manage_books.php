...
if (mysqli_num_rows($all_query) > 0) {
    ...
    echo "<td><form action='edit_book.php?id=$row[book_id]' method='POST'><button  class='btn btn-success' id='btn' name='booked'>Edit</button></form>
    <form action='cancel.php?id=$row[book_id]' method='POST'><button  class='btn btn-danger'  name='booked'>Delete</button></form></td>";
